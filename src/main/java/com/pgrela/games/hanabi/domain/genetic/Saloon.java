...
public class Saloon {
    ...
    public static final int TESTING_DECKS = 5;
    ...
    public static void main(String[] args) {
        ...
        Pangea pangea = new PangeaBuilder<CheaterGenome>()
                .withHerd(Stream.generate(CheaterGenome::random).limit(100).collect(Collectors.toList()))
    ...
    private static SurvivalSkills test(List<Deck> decks, CheaterGenome genome) {
        int score = 0;
        for (Deck deck : decks) {
