...
public class Hanabi {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < simulations; i++) {
            ...
            Game game = GameFactory.setupNewGame(()->new Cheater(CheaterGenome.fromString("[15--,1--1,5D--,D3--,D--3,-1H-,2--H,---4,--3-,-3--]")), 4);
            ...
            //Game game = GameFactory.setupNewGame(SingleHinter::new, 4);
            game.start();
            scores.add(game.score());
            if (game.score() <1 || game.getAvailableBlownTokens()<3) {
